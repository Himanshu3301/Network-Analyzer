...
<?php include 'host.php';?>
	<a href="http://<?=$var?>/oleald/pages/deleteip1.php" class="button">Delete IP</a>
	<a href="http://<?=$var?>/oleald/pages/deletecommand1.php" class="button">Delete custom command </a
      </div>
      <!-- ################################################################################################ -->
    </div>
    <!-- ################################################################################################ -->

...
include 'host.php';
?>
	<a href="http://<?=$var?>:3000" class="button">View Statistics</a>
	<a href="http://<?=$var?>/oleald/pages/add.php" class="button">Add IP</a>
	<a href="http://<?=$var?>/oleald/pages/delete.php" class="button">Delete IP</a
      </div>
      <!-- ################################################################################################ -->
    </div>
    <!-- ################################################################################################ -->
